  ...
  const features = [
    {
      ...
      description:
        'Cadastre e gerencie todos os seus imóveis em uma interface intuitiva e profissional.',
    },
    {
      icon: <Users className="h-6 w-6 text-[#9747FF]" />,
      title: 'Leads Qualificados',
      description:
        'Receba e gerencie leads qualificados diretamente na plataforma, aumentando suas chances de conversão.',
    },
    {
    ...
    },
    {
      ...
      description:
        'Tenha seu próprio site personalizado para mostrar apenas seus imóveis e destacar seu trabalho.',
    },
  ];
      ...
      >
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-8">
            <a href="#recursos" className="text-gray-600 hover:text-[#9747FF] transition-colors">
              Recursos
            </a>
            <a href="#dashboard" className="text-gray-600 hover:text-[#9747FF] transition-colors">
              Dashboard
            </a>
            <a href="#depoimentos" className="text-gray-600 hover:text-[#9747FF] transition-colors">
              Depoimentos
            </a>
            <a href="#contato" className="text-gray-600 hover:text-[#9747FF] transition-colors">
              Contato
            </a>
          </div>
        ...
        <div className="container mx-auto px-4 grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-[#362D3E] leading-tight">
              <span className="text-[#9747FF]">Automatize</span>, simplifique e{' '}
              <span className="text-[#9747FF]">venda mais</span>
            </h1>
            <p className="text-xl text-gray-600">
              <span className="font-semibold">iMoobile</span> é a plataforma completa onde
              corretores e imobiliárias tradicionais se transformam em negócios digitais de alto
              desempenho.
            </p>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="space-y-6">
                <h3 className="text-2xl font-bold text-[#362D3E]">
      ...
      <section id="depoimentos" className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Histórias de sucesso de corretores e imobiliárias que transformaram seus negócios com
              o iMoobile
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                testimonial:
                  'Encontrei o apartamento perfeito para minha família através do iMoobile. O processo foi transparente e o atendimento foi excepcional. Recomendo a todos que buscam um imóvel com segurança e eficiência.',
              },
              {
                name: 'Sergio Filho',
                role: 'Empresário',
                testimonial:
                  'Como investidor, preciso de uma plataforma confiável para encontrar bons negócios. O iMoobile superou minhas expectativas, oferecendo uma seleção diversificada de imóveis e um suporte impecável durante todo o processo.',
              },
              {
                name: 'Hercules Dutra',
                role: 'Advogado',
                testimonial:
                  'A experiência de comprar meu primeiro imóvel foi transformada pelo iMoobile. A facilidade de navegação, as informações detalhadas e o suporte personalizado tornaram o processo muito mais tranquilo e seguro.',
              },
              ...
              >
                <div className="flex items-center mb-4">
                  <div className="w-12 h-12 bg-[#9747FF] rounded-full mr-4 flex items-center justify-center text-white font-bold">
                    {testimonial.name
                      .split(' ')
                      .map(n => n[0])
                      .join('')}
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <a href="#depoimentos" className="text-gray-400 hover:text-white">
                    Depoimentos
                  </a>
                </li>
              </ul>
