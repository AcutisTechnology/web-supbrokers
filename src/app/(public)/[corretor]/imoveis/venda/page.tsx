...
export default function ImoveisVendaPage({ params }: { params: Promise<{ corretor: string }> }) {
  ...
  const items = all.filter((p) => p.sale);
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      >
        ...
        <h1 className="font-medium text-3xl md:text-5xl text-white mt-6 leading-snug">Imóveis à venda</h1>
        <p className="text-white text-lg md:text-xl mt-2">Todos os imóveis disponíveis para compra.</p>
      </div>
      ...
      <section className="py-12">
        <div className="container mx-auto px-4">
          {items.length > 0 ? (
            ...
            <p className="text-[#777777]">Nenhum imóvel à venda.</p>
          )}
        </div>
      </section>
    </div>
