...
export default function DemandasPage() {
  ...
  const [draft, setDraft] = useState({ search: "", status: ALL, property_type: ALL });
  ...
  const applyFilters = () => {
    ...
    setFilters({
      ...
      property_type: draft.property_type !== ALL ? draft.property_type : undefined,
    });
  };

  const clearFilters = () => {
    setDraft({ search: "", status: ALL, property_type: ALL });
    setFilters({});
    setPage(1);
  };
      ...
      <main className="p-4 sm:p-6">
        ...
        <Card className="p-4 mb-6 shadow-sm">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            ...
            <Select value={draft.property_type} onValueChange={v => setDraft(d => ({ ...d, property_type: v }))}>
          ...
          <>
                            ...
                            <AlertDialogContent>
                              <AlertDialogHeader>
                                ...
                                <AlertDialogDescription>
                                  Esta ação não pode ser desfeita. Os matches serão removidos.
                                </AlertDialogDescription>
                              </AlertDialogHeader>
                              <AlertDialogFooter>
            ...
            {data?.meta && data.meta.last_page > 1 && (
              <div className="flex items-center justify-center gap-2 mt-6">
                ...
                <span className="text-sm text-gray-600">{page} / {data.meta.last_page}</span>
